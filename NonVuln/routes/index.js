...
//const { requireSignin, isAuth } = require('../middlerware/auth');
...
router.post('/transfer', function (req, res, next) {
	...
	var jwtAuthHeaderVal = req.headers.authorization;
	var jwtToken = jwtAuthHeaderVal.split(" ");
	console.log("asdasfsafasfasafasfs")
	console.log(jwtToken);

	njwt.verify(jwtToken[1], secretKey, (err, verifiedJwt) => {
		if(err){
